...
namespace izzynab.CustomPostProcessingStack
{
    ...
    [CustomPostProcess("Chromatic Split", CustomPostProcessInjectionPoint.AfterPostProcess | CustomPostProcessInjectionPoint.BeforePostProcess)]
    public class ChromaSplitEffectRenderer : CustomPostProcessRenderer
    {
        ...
        {
            m_Material = CoreUtils.CreateEngineMaterial("Hidden/CustomPostProcess/ChromaSplit");
        }
