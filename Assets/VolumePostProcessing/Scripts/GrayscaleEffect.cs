...
namespace izzynab.CustomPostProcessingStack
{
    ...
    [CustomPostProcess("Grayscale", CustomPostProcessInjectionPoint.AfterOpaque | CustomPostProcessInjectionPoint.BeforePostProcess | CustomPostProcessInjectionPoint.AfterPostProcess)]
    public class GrayscaleEffectRenderer : CustomPostProcessRenderer
    {
        ...
        {
            m_Material = CoreUtils.CreateEngineMaterial("Hidden/CustomPostProcess/Grayscale");
        }
