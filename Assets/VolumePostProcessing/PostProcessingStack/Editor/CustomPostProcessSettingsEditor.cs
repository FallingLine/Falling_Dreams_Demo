...
internal class CustomPostProcessSettingsEditor : PropertyDrawer
{
    ...
    {
        public ReorderableList listAfterOpaque, listBeforePostProcess, listAfterPostProcess;
    }
    ...
    private void Init(SerializedProperty property)
    {
        ...
        if (!propertyStates.ContainsKey(path))
        {
            ...
            InitList(ref state.listAfterOpaque, feature.settings.renderersAfterOpaque, "After Opaque", CustomPostProcessInjectionPoint.AfterOpaque, feature);
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        state.listAfterOpaque.DoLayoutList();
    ...
    private void populateRenderers()
    {
        ...
        _availableRenderers = new Dictionary<CustomPostProcessInjectionPoint, List<Type>>(){
                { CustomPostProcessInjectionPoint.AfterOpaque, new List<Type>() },
        ...
        foreach (var type in TypeCache.GetTypesDerivedFrom<CustomPostProcessRenderer>())
        {
            ...
            if (attribute.InjectionPoint.HasFlag(CustomPostProcessInjectionPoint.AfterOpaque))
                _availableRenderers[CustomPostProcessInjectionPoint.AfterOpaque].Add(type);
